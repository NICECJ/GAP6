...
python3 pyasn_util_download.py --latestv6 --filename "$INPUT_DIR/rib.bz2"
...
python3 pyasn_util_convert.py --single "$INPUT_DIR/rib.bz2" "$INPUT_DIR/ipasn.dat"
...
python3 extract_BGP_prefixes.py "$INPUT_DIR/ipasn.dat" "$INPUT_DIR/BGP_prefixes.txt"
