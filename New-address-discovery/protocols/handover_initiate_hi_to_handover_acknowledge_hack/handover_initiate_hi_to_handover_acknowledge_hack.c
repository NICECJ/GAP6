#include "handover_initiate_hi_to_handover_acknowledge_hack.h"
...
int handover_initiate_hi_to_handover_acknowledge_hack_parse_response(const uint8_t *buffer,
    ...
    if (icmp6_hdr->icmp6_type != 154 || icmp6_hdr->icmp6_code != 5)
        return 0;
...
protocol_t handover_initiate_hi_to_handover_acknowledge_hack_protocol = {
    .name = "handover_initiate_hi_to_handover_acknowledge_hack",
    .build_probe = handover_initiate_hi_to_handover_acknowledge_hack_build_probe,
    .parse_response = handover_initiate_hi_to_handover_acknowledge_hack_parse_response
};

/* automatic registration */
__attribute__((constructor))
static void register_handover_initiate_hi_to_handover_acknowledge_hack()
{
    register_protocol(&handover_initiate_hi_to_handover_acknowledge_hack_protocol);
}