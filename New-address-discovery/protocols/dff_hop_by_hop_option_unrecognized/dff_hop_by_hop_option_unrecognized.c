#include "dff_hop_by_hop_option_unrecognized.h"
...
int dff_hop_by_hop_option_unrecognized_parse_response(const uint8_t *buffer,
    ...
    if (icmp6_hdr->icmp6_type != ICMP6_PARAM_PROB || icmp6_hdr->icmp6_code != 2)
        return 0;
    ...
    *target_ip = ip6_hdr->ip6_src;
    ...
    uint32_t seq = ntohl(icmp6_hdr->icmp6_seq);
    *prefix_index = seq >> 8;
...
protocol_t dff_hop_by_hop_option_unrecognized_protocol = {
    .name = "dff_hop_by_hop_option_unrecognized",
    .build_probe = dff_hop_by_hop_option_unrecognized_build_probe,
    .parse_response = dff_hop_by_hop_option_unrecognized_parse_response
};

/* automatic registration */
__attribute__((constructor))
static void register_dff_hop_by_hop_option_unrecognized()
{
    register_protocol(&dff_hop_by_hop_option_unrecognized_protocol);
}