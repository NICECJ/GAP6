#include "solicited_node_multicast_probing.h"
...
int solicited_node_multicast_probing_build_probe(struct ethhdr *eth,
                                                struct ip6_hdr *ip6,
...
int solicited_node_multicast_probing_parse_response(const uint8_t *buffer,
    ...
    struct nd_neighbor_advert* na =
        (struct nd_neighbor_advert*)icmp6_hdr;
...
protocol_t solicited_node_multicast_probing_protocol = {
    .name = "solicited_node_multicast_probing",
    .build_probe = solicited_node_multicast_probing_build_probe,
    .parse_response = solicited_node_multicast_probing_parse_response
};

/* automatic registration */
__attribute__((constructor))
static void register_solicited_node_multicast_probing()
{
    register_protocol(&solicited_node_multicast_probing_protocol);
}