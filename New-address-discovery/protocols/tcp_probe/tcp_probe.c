...
protocol_t tcp_probe_protocol = {
    .name = "tcp_probe",
    .build_probe = tcp_probe_build_probe,
    .parse_response = tcp_probe_parse_response
};

__attribute__((constructor))
static void register_tcp_probe(void) {
    register_protocol(&tcp_probe_protocol);
}
